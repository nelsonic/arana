...
test('url_transform else (no transform) branch test', function(t){
...
test('url_transform followers to profile route', function(t){
  var url = 'https://github.com/iteles/followers'
  var data = {url:url}
  var data = url_transform(data, 'followers');
  t.ok(data.url === '/iteles', "✓ url_transform: " +url +" >> "+data.url)
  // console.log(url);
  t.end();
});

test('url_transform followers url to base (profile) path', function(t){
  var url = 'https://github.com/iteles/followers'
  var data = {url:url}
  var data = url_transform(data, 'followers');
  t.ok(data.url === '/iteles', "✓ url_transform: " +url +" >> "+data.url)
...
test('url_transform following url to base (profile) path', function(t){
  var url = 'https://github.com/iteles/following'
  var data = {url:url}
  var data = url_transform(data, 'following');
  t.ok(data.url === '/iteles', "✓ url_transform: " +url +" >> "+data.url)
  // console.log(url);
  t.end();
});

test('url_transform strips labels from repo url', function(t){
...
test('url_transform strips milestones from repo url', function(t){
